...
const loginWithPuppeteer = async (email, password, config) => {
  try {
    ...
    await page.goto(
      `https://unite.nike.com/s3/unite/mobile.html?androidSDKVersion=3.1.0&corsoverride=https://unite.nike.com&uxid=${config.ux_id}&locale=en_US&backendEnvironment=identity&view=login&clientId=${config.client_id}&facebookAppId=84697719333&wechatAppId=wxde7d0246cfaf32f7#%7B`
    );
